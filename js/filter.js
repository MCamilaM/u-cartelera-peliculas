...
function getMovies() {
    ...
    const movies = [
        ...
        { id: 2, name: 'Posesión infernal El despertar', year: 2023, category: ['Terror'], score: '7.3', duration:'1h 37min', image: 'img/movie2/movie2.jpg', sipnosis: 'Beth visita a su hermana mayor, Ella, que está criando a 3 niños en un pequeño apartamento en Los Ángeles. Su reunión es muy corta cuando encuentran un libro demoníaco, The Necronomicon Ex-Mortis.' , html:'movies/movie1.html'},
